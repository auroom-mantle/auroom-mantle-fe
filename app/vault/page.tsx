            ...
            <div className="container mx-auto px-4">
                <div className="max-w-2xl mx-auto space-y-6">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-white/60">Stake XAUT to earn yield from LP provision</p>
                    </div>
                    ...
                    <div className="p-6 rounded-2xl bg-zinc-900 border-2 border-yellow-500/30">
                        ...
                        <Tabs defaultValue="deposit">
                            <TabsList className="grid w-full grid-cols-2 bg-black border border-yellow-500/20">
                                <TabsTrigger
                                    value="deposit"
                                    className="text-white/60 data-[state=active]:bg-yellow-500/20 data-[state=active]:text-yellow-400"
                                >
                                    Deposit
                                </TabsTrigger>
                                <TabsTrigger
                            ...
                            <TabsContent value="deposit" className="space-y-4 mt-4">
                                <div className="space-y-2">
                                    <div className="flex justify-between text-sm">
                                        <span className="text-white/60">XAUT Balance</span>
                                        <span className="text-white">{xautBalance ? formatTokenAmount(xautBalance as bigint, TOKENS.XAUT.decimals, 4) : '0.0000'}</span>
                                    </div>
                                ...
                                {vault.isSuccess && vault.hash && (
                                    <div className="p-3 bg-green-500/10 border border-green-500/30 rounded-lg text-sm">
                                        <p className="font-medium mb-1 text-green-400">Deposit successful!</p>
                                        <a
                                ...
                                {(approval.error || vault.error) && (
                                    <div className="p-3 bg-red-500/10 border border-red-500/30 rounded-lg text-sm text-red-400">
                                        Error: {approval.error?.message || vault.error?.message}
                                    </div>
                                )}
                            </TabsContent>
                            ...
                            <TabsContent value="withdraw" className="space-y-4 mt-4">
                                <div className="space-y-2">
                                    <div className="flex justify-between text-sm">
                                        <span className="text-white/60">gXAUT Balance</span>
                                        <span className="text-white">{gxautBalance ? formatTokenAmount(gxautBalance as bigint, TOKENS.gXAUT.decimals, 4) : '0.0000'}</span>
                                    </div>
                                    <div className="flex gap-2">
                                        <Input
                                            type="text"
                                ...
                                {vault.isSuccess && vault.hash && (
                                    <div className="p-3 bg-green-500/10 border border-green-500/30 rounded-lg text-sm">
                                        <p className="font-medium mb-1 text-green-400">Withdrawal successful!</p>
                                        <a
                                            href={getExplorerTxUrl(vault.hash)}
                                            target="_blank"
                                            rel="noopener noreferrer"
